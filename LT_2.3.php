...
<html>
<title>Abadilla Portfolio</title>
<meta charset="UTF-8">
...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
    <a href="index.php" class="w3-bar-item w3-button"><b>Abadilla Portfolio</a>
   
    <div class="w3-right w3-hide-small">
      <a href="index.php" class="w3-bar-item w3-button">Home</a>
      <a href="css.php" class="w3-bar-item w3-button">Css</a>
      <a href="svg.php" class="w3-bar-item w3-button">Svg</a>
	    <a href="canvas.php" class="w3-bar-item w3-button">Canvas</a>
    </div>
  </div>
</div>
...
<div class="topnav"> 
 <div class="topnav-centered"> 
  ...
  <a  href="LT_2.3.php">HOME</a>
  <a href="LT_2.3.php">ABOUT US</a>
  <a href="LT_2.3.php">PRODUCTS</a>
  <a href="LT_2.3.php">CONTACT US</a>
  </div>
  </div>
  <div id="first-layer">
...
<br>
<div class="div2">LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM
LOREM IPSUM LOREM IPSUM</div>

<div class="div3">LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM
LOREM IPSUM LOREM IPSUM</div>
<div class="div4">LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM
LOREM IPSUM LOREM IPSUM</div>
